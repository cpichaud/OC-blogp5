...
class PostManager extends connectionDb
{
     ...
     * @return int
     */
    public function createPost(string $title, string $content, $created_at, $update_at, int $user_id)
    {
        $sql = "INSERT INTO post(content, title, created_at, update_at, user_id)  
        VALUES (:content, :title, :created_at, :update_at, :user_id)" ;
